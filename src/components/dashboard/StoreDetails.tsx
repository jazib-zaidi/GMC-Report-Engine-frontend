...
import TableLoadingSkeleton from '../insights/TableLoadingSkeleton';
...
const StoreDetails = () => {
  ...
  const topPerformingProducts = getTopPerformingProducts(
    liaStoreData?.data || []
  );
  ...
  const productattributeData = groupByAttribute(liaStoreData?.data, [
    `${selectedAttribute}`,
  ]);
                  ...
                  <div className=' absolute top-[-130px] left-0 z-10 opacity-0 scale-95 transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:scale-100 pointer-events-none bg-white border rounded-md shadow-lg p-2'>
                    <div className=''>
                      <img
                        ...
                        alt={product.product_title}
                      />
                      <p className='p-2  underline'>{product.product_title}</p>
                    </div>
                  </div>
  ...
  return (
    <div>
      ...
      <h1 className='text-lg font-semibold '>
        {' '}
        Store Code ({decodedId.split('/')[1]}) Performance{' '}
      </h1>

      <br />
      <LiaMetrics matrices={matrices} />
      <br />
      <div className='flex items-center justify-between mb-4'>
        ...
        <div className='rounded-lg flex flex-col w-1/3'>
          <div className='flex flex-col items-center'>
            {/* <div className=' text-md text-start font-medium text-gray-700 '> */}
            Group By:
            <br />
            <Select
